...
Tuve la suerte que en mis prácticas estuve en distintas obras, por lo que pude ver de primera mano que, cada obra es un mundo. Cada encargado de obra es distinto, piensa, actúa y exige cosas distintas, en esto, viene influenciado por la situación de la obra, su personalidad y su educación. Y el topógrafo debe saber adaptarse a esas exigencias, y por supuesto, saber tratar con cada encargado de obra.
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="{{ '/assets/img/1787169185471.jpg' | relative_url }}" alt=" Ejemplo de voladizos que entorpecen la marcación de elementos." style="max-width: 50%; height: auto; border-radius: 8px; display: block; margin: 0 auto;">
