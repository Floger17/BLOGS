...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="{{ '/assets/img/FERIA_DEL_INVENTO.png' | relative_url }}" alt="Este soy yo en la Feria del Invento de la UPV." style="max-width: 100%; height: auto; border-radius: 8px;">
  <figcaption style="font-size: 0.85rem; color: #64748b; margin-top: 0.5rem; font-style: italic;">
