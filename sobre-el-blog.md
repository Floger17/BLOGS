...
<style> 
  ...
  main p, main ul, main ol { text-align: justify; } 
  /* Mantiene el pie de foto centrado */ 
  figcaption { text-align: center !important; } 

  /* Efecto interactivo al pasar el cursor sobre los botones */
  .btn-action {
...
Mi objetivo con esta plataforma es conectar la teoría académica con la realidad del trabajo de campo y gabinete, visibilizando el impacto directo de la geomática en la ingeniería, el territorio y la gestión de emergencias.
...
## Orientación Profesional y Colaboración
Mantengo este blog como muestra de mi compromiso y rigor con la ingeniería geoespacial. Estoy permanentemente abierto a colaboraciones técnicas, investigación y nuevas oportunidades en el sector que me permitan seguir aportando soluciones mediante la geoinformática y la topografía.

<div style="margin-top: 25px; display: flex; gap: 15px; flex-wrap: wrap;">
  <a href="mailto:fabioregolf7@gmail.com" target="_blank" class="btn-action" style="background-color: #8a4939; color: white; padding: 10px 18px; border-radius: 6px; text-decoration: none; font-weight: bold; display: inline-flex; align-items: center; gap: 8px;">📩 Contactar por Email</a>
  <a href="https://www.linkedin.com/in/fabio-regolf-ari%C3%B1o-a58305328/" target="_blank" rel="noopener noreferrer" class="btn-action" style="background-color: #0e76a8; color: white; padding: 10px 18px; border-radius: 6px; text-decoration: none; font-weight: bold; display: inline-flex; align-items: center; gap: 8px;">🔗 Perfil de LinkedIn</a>
</div>
